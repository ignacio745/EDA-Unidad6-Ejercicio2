...
class DigrafoSecuencial:
    ...
    def __init__(self, nodos:int, arcos:list[tuple[int]]) -> None:
        ...
        self.__arreglo = np.empty((self.__cant_nodos, self.__cant_nodos), int)
    ...
    def set_arco(self,  nodo_origen:int, nodo_destino:int, valor:int):
        self.__arreglo[nodo_origen][nodo_destino] = valor
    
    def get_arco(self, nodo_origen:int, nodo_destino:int):
        return self.__arreglo[nodo_origen][nodo_destino]
